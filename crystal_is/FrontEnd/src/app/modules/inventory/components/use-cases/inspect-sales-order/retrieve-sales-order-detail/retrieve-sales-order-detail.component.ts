...
import { Customer } from '../../../../../sales/data-models/business-models/customer';
...
import { CustomerService } from '../../../../../sales/data-services/customer/customer.service';
import { UnitService } from '../../../../data-services/unit/unit.service';

@Component({
  selector: 'app-retrieve-sales-order-detail',
  templateUrl: './retrieve-sales-order-detail.component.html',
  styleUrls: ['./retrieve-sales-order-detail.component.css']
})
export class RetrieveSalesOrderDetailComponent implements OnInit {
